            ...
            <div class="row">
                <div class="col-lg-9 mx-auto">
                    ...
                    <section class="related-posts">
                        <h2 class="section-title mb-4" data-aos="fade-up">Вам также может понравится</h2>
                        <div class="row">
                        ...
                        <form action="{{ route('post.comment.store', $post->id) }}" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-12" data-aos="fade-up">
                                    ...
                                    <textarea name="message" id="comment" class="form-control" placeholder="Напишите свой комментарий тут" rows="10"></textarea>
